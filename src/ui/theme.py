...
APP_STYLE = """
    ...
    QPushButton {
        ...
        padding:7px 12px; color:#475467; font-weight:600;
    }
    QPushButton:hover { background:#f1f5ff; border-color:#b8c9eb; }
    QPushButton:pressed { background:#e8eef9; }
    QPushButton#primaryButton {
        background:#4f76e8; color:#ffffff; border:none; font-weight:700;
    }
    ...
    QTabBar::tab:selected { color:#315fc9; border-bottom:2px solid #4f76e8; font-weight:700; }
"""
...
SETTINGS_STYLE = APP_STYLE + """
    ...
    QLabel#sectionTitle { color:#4771db; font-size:16px; font-weight:700; }
    QLabel#rowLabel { color:#475467; font-size:13px; font-weight:600; }
    QLabel#hintLabel { color:#98a2b3; font-size:11px; }
    QLabel#fixedChip {
        background:#eef2ff; border:1px solid #cbd7fa; border-radius:9px;
        color:#425a9a; padding:7px 10px; font-weight:600;
    }
    ...
    QPushButton#choiceChip:checked {
        background:#eef2ff; border:1px solid #aebff2; color:#3f5db5; font-weight:700;
    }
